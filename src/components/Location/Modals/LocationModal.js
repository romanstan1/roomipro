...
export default class LocationModal extends Component {
  ...
  render () {
    ...
    const {url, secondary, main, seats, id, lat, lng} = this.state
    return (
      <Dialog
        open={locationOpen}
        ...
        <div className='modal notification'>
          ...
          <div className='display-post'>
            ...
            <div className='latlng'>
              <div>Latitude</div>
              <input onChange={this.handleTextInput} value={lat} data-type='lat' type="number"/>
              <div>Longitude</div>
              <input onChange={this.handleTextInput} value={lng} data-type='lng' type="number"/>
            </div>
          </div>
